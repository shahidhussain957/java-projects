...
public class ArrayList_Example{
    public static void main(String args[]){
        ...
        System.out.println("Checking that an arraylist cantains that no. which we're looking for:"+list.contains(55));

        //Getting element at index 3 using get().
        System.out.println("Getting element at index by using get() is: "+list.get(3));

        //Delete elements from arraylist        
        System.out.println("Removing element by remove() method:"+list.remove(3));

        //Sorting of an arraylist in ascending order
        Collections.sort(list);
        System.out.println("Sorting an element by using Collection.sort(list) class is:"+list);

        //Size of an ArrayList.
        System.out.println("The Size of an ArrayList is: " + list.size());
